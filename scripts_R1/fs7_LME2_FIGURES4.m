%% Supplementary Materials Section 4 presents additional analyses performed at the single connection level, showing that this connection is significantly modulated by speaker gaze, (Full gaze > Partial or No gaze, t221 = 3.48 and BHFDR-corrected p < .05), consistent with previous published research (Leong et al., 2017).
clc
clear all
...
%% R1  (Full gaze > Partial or No gaze, t221 = 3.48 and BHFDR-corrected p < .05)
...
%% T VALUE AND THRESHOULD FOR FIG 4D
